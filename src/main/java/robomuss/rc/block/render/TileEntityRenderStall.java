...
public class TileEntityRenderStall extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float f) {
		...
		if(tes.camouflage != null) {
			textures = new ResourceLocation(tes.camouflage.getIconIndex().getIconName());
//			textures = new ResourceLocation("textures/blocks/" + tes.camouflage.getIconIndex().getIconName() + ".png");
		}
