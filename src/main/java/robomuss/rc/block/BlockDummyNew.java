...
public class BlockDummyNew extends BlockContainer {
	...
	public IIcon getIcon(int side, int meta) {
		if (this.teDummy.teSlope.track == null) {

		} else if (this.teDummy.teSlope.track_type instanceof TrackPieceSlopeUp) {
			return icons[0];
		} else if (this.teDummy.teSlope.track_type instanceof TrackPieceSlope) {
			return icons[1];
		} else if (this.teDummy.teSlope.track_type instanceof TrackPieceSlopeDown) {
			return icons[2];
		}
