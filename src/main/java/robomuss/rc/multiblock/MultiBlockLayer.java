...
//	private boolean hasPartnerLayer;
...
//	}
//
//	public MultiBlockLayer(int layerID, int layerWidth, int layerDepth, Block[] blocks, int[] dummies) {
//		this(layerID, layerWidth, layerDepth, blocks);
...
//		return new int[] {getLayerWidth(), getLayerDepth()};
//	}
//
