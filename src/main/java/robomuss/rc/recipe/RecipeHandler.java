...
public class RecipeHandler {
	...
	private void registerItemRecipes() {
		GameRegistry.addRecipe(new ItemStack(RCItems.train), "XYX", "XXX", 'X', Items.iron_ingot, 'Y', TrackHandler.Types.HORIZONTAL.type.block);
	...
	private void registerBlockRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(RCBlocks.track_storage), "XXX", "XYX", "XXX", 'X', Items.iron_ingot, 'Y', TrackHandler.Types.HORIZONTAL.type.block);
